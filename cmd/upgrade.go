...
func CheckNewRelease() {
	...
	_, _ = fmt.Fprintf(os.Stderr, "Good news, everyone! New kbt version (v%s) is out, "+
		"you can read the release notes here: https://github.com/adyatlov/kbt/releases/latest\n",
	...
	if err := gh.upgradeExecutable("kbt"); err != nil {
